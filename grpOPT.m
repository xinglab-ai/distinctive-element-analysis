function varargout = grpOPT(X, k, varargin)

% This code is developed following k-means clustering code of MATLAB Inc.
%grpOPT group optimized clustering
%
%   grpOPT treats NaNs as missing data, and ignores any rows of X that
%   contain NaNs.
%
%   [IDX, C, SUMD, D] = grpOPT(X, K) returns distances from each point
